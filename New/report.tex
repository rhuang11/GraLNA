...
\title{Interim Report: Detecting Fraud and Misstatements in Annual Financial Statement Reports}
...
\begin{abstract} We develop a new fraud detection model that builds upon existing machine learning methods and incorporates recent technological advances in the Large Language Model field such as GPT-4 and GPT-4o. We demonstrate that combining deep learning knowledge with domain knowledge is beneficial towards fraud detection. We differ from previous research by using textual and linguistic data from annual 10-k financial statements in addition to the raw accounting numbers. 
\end{abstract}

\begin{IEEEkeywords}
Fraud Detection, Large Language Models, Ensemble Learning, Neural Networks, Machine Learning
\end{IEEEkeywords}
...
\centering
\begin{tabular}{@{}p{2.4cm}p{6cm}@{}} 
\toprule
\textbf{Abbreviation} & \textbf{Financial Variable} \\
\midrule
...
SVM-FK & 0.503 & 0.010 & 1.321\% & 1.130\% \\
RUSBoost & 0.690 & 0.022 & 2.265\% & 1.997\% \\
\bottomrule
\end{tabular}
\label{tab1}
\end{table}
